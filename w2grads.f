...
10    CALL READHEADER(99,NAME,KEYWORD,FLTNAME,
     ...
     + POWERT,BIEL,AZBIEL,ETIME1,STIME2,EXTRA6,EXTRA7)
      ...
      PRINT *, 'creatime: ', CREATIME
      PRINT *, 'fltname: ',  FLTNAME
      PRINT *, 'stmname: ', STMNAME
      ...
      PRINT *, 'flag: ', FLAG
      PRINT *, 'extra2: ', EXTRA2
      PRINT *, 'EXTRA3,STIME,ETIME,OLAT,OLON,SX,SY,SZ,XZ,YZ,ZZ'
      PRINT *, EXTRA3,STIME,ETIME,OLAT,OLON,SX,SY,SZ,XZ,YZ,ZZ
      PRINT *, 'ROT,RA,CO1,CO2,AZMCOR,ELCOR,THRESH,POWERT,BIEL'
      PRINT *, ROT,RA,CO1,CO2,AZMCOR,ELCOR,THRESH,POWERT,BIEL
      PRINT *, 'AZBIEL,ETIME1,STIME2,EXTRA6,EXTRA7'
      PRINT *, AZBIEL,ETIME1,STIME2,EXTRA6,EXTRA7
     ...
     c          DB(I), DV(I)
         IF(IUV.EQ.0)THEN
          ...
          IF (WDR.LT.0.) THEN                                              
           ...
           V(I,J,K)=FLAG
          ELSE                                                             
c           CALL COMP(XU,XV,WDR,WSP) (convert to polar coordinate from cartesian?)
